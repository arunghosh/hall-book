app.controller('filterController', function($scope, hallApi, slotApi, filterSrv){

    $scope.halls = [];
    $scope.maxgWidth = 24 * filterSrv.SLOT_SCALE;
    $scope.times = slotApi.hourSlots(filterSrv.SLOT_SCALE);
...
app.service('filterSrv', function(slotApi){
    ...
    this.formatSlots = function(rslt, halls, scale){
        ...
        {
            slotApi.initSlot(rslt.slots[j], scale);
        }
